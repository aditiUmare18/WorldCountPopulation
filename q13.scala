...
object q13 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //    Question 13:  RURAL population of Countries which are More Developed
        ...
        val result = population.select(col("COUNTRY"), col("left.D_2025").alias("RURAL")).filter("DEVELOPMENT = 'MORE DEVELOPED'").na.fill("0")

        result.show()

        result.coalesce(1).write.mode("overwrite").orc("C:\\Users\\nkuma309\\OneDrive - Capgemini\\Desktop\\SprintResults\\q13.orc")
